...
public class RingReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(request_code != 0) {
            ...
            pintent_ring.putExtra("request_code", request_code);
            ...
            alarmIntent = PendingIntent.getBroadcast(context, request_code, pintent_ring, PendingIntent.FLAG_UPDATE_CURRENT);
